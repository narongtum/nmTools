...
plp.pin_locator_polygon(		poly_mesh = 'for_dup_hair',
								vtxNum = '49',
								locator_scale = 1.0,
								prefix = 'Rivet',
								region = 'hair',
...
def pin_locator_polygon(		poly_mesh = 'for_dup_hair',
	...
	uvPin = pm.createNode('uvPin', name = f'{prefix}_{base_name}_uvPin')
	...
	pName = f'{prefix}_{base_name}_loc'
