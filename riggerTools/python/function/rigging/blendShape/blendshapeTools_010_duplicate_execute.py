...
# Eyeball
eyelidAll_dict = bshTools.createBshToPly( bsh_dict = bshTools.EYELID_ALL_DICT , side = 'LFT')
eyelidAll_dict = bshTools.createBshToPly( bsh_dict = bshTools.EYELID_ALL_DICT , side = 'RGT')
...
# Nose Mid
noseMid_dict = bshTools.createBshToPly( bsh_dict = bshTools.NOSE_ALL_DICT , side = '')
# Nose Side
noseLFT_dict = bshTools.createBshToPly( bsh_dict = bshTools.NOSE_SIDE_DICT , side = 'LFT')
noseRGT_dict = bshTools.createBshToPly( bsh_dict = bshTools.NOSE_SIDE_DICT , side = 'RGT')

# Cheek
cheekLFT_dict = bshTools.createBshToPly( bsh_dict = bshTools.CHEEK_DICT , side = 'LFT')
cheekRGT_dict = bshTools.createBshToPly( bsh_dict = bshTools.CHEEK_DICT , side = 'RGT')

# Face
jaw_dict = bshTools.createBshToPly( bsh_dict = bshTools.JAW_DICT , side = '')
