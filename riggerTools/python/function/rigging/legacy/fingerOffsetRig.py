'''
DUPLICATE FINGER CURL MODULE WHY WHYYYY
from axionTools.rigging import fingerOffsetRig 
...
def defineVariable( fingerbehavior, fingerName , side , ctrlName , numCtrl):
	
	return fingerName,fingerbehavior,side,ctrlName,numCtrl
