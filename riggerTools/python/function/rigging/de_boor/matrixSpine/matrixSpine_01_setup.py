...
# ------- EXAMPLES -------- #
#... Must have Main controller and temp loc
# 1. Place main ctrl 'L_mainCV01'
# 2. Place child ctrl 'L_child01'
# 3. Define number of main ctrl
# 4. Define number of child ctrl
...
for num in range(count):
	...
	cv = _creParentCtrl(size=cvSize, color=color, name = '{0}_{2}{1:02d}'.format(side, startNum, mainName), ctrlShape = 'cube_ctrlShape')
...
for num in range(count):
	num = num +1
	print(num)
	main_ctrl = '{0}_{2}{1:02d}_ctrl'.format(side, num, mainName)
	source_temp_loc = '{0}_{2}{1:02d}'.format(side, num, mainName)
...
for i in range(pCount):
	...
	pNode = _creParentCtrl(size=0.02, color='white', name = '{0}_{2}{1:02d}'.format(side, num, childName), ctrlShape = 'plainSphereB_ctrlShape')
