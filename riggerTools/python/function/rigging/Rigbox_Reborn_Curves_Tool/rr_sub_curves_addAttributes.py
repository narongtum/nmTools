"""
NOTE: This script has been cleaned to use consistent 4-space indentation only.
All previous tab characters were replaced to avoid indentation errors in Python 3.
"""
...
Description:
	...
	Allows for additional, custom attributes, to be added to objects
...
def field_display(*args):
	...
	print ('Attribute Creation GUI has been updated.')
