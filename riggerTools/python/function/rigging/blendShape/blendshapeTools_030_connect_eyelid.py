...
lid_parCons = core.parentConstraint( 'eyeLidUpMain02%s_loc' %side , zro_grp , mo = True)
...
# mid locator specific name fix later
lid_parCons = core.parentConstraint( 'eyeLidLoMain02%s_loc' %side , zro_grp , mo = True)
lid_parCons.name = part + side
lid_parCons.suffix
