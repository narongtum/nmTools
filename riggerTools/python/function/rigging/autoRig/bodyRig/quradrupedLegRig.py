...
def quradrupedLegRig(		nameSpace = '' 	,	
	...
	# Create Attr
	# Because of animal leg so move to anlke
	# lowerLegIK_ctrl.addAttribute(  attributeType = 'long' ,ln = 'autoStretch' 	, k = True , minValue = 0 , maxValue = 1 ,dv = 0 )
	# lowerLegIK_ctrl.addAttribute(  attributeType = 'float' ,ln = 'upStretch' 	, k = True  ,dv = 0 )
	# lowerLegIK_ctrl.addAttribute(  attributeType = 'float' ,ln = 'lowStretch' 	, k = True  ,dv = 0 )

	# comment for test
	# lowerLegIK_ctrl.hideArnoldNode()
